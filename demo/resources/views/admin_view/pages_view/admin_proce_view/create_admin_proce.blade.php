...
@section('view_create_legalAdvice')
    <div class="container-fluid">
        <!-- Title -->
        <div class="row heading-bg">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Thêm Mới Danh Mục Thủ Tục Hành Chính</h5>
            </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-wrap">
                                        <form action="{{ route('create_Proce') }}" data-toggle="validator"
                                            ...
                                            <div class="col-md-12" style="padding: 0px;">
                                                <div
                                                    ...
                                                    <input type="text" class="form-control" id="slug"
                                                        onkeyup="ChangeToSlug();" placeholder="ví dụ: Giấy Phép Con"
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input type="text" class="form-control" id="convert_slug"
                                                        placeholder="ví dụ: giay-phep-con" readonly name="linkText"
                                                        value="{{ old('linkText') }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="inputRadio" class="control-label mb-10">Trạng Thái</label>
                                                    <div class="radio">
                                                        <input type="radio" id="box" name="status" value="1" {{old('status') == 1 ? 'checked' : ''}}>
                                                        <label for="box"> Hoạt Động </label>
                                                    </div>
                                                    <div class="radio">
                                                        <input type="radio" id="bri" name="status" value="0" {{old('status') == 0 ? 'checked' : ''}}>
                                            ...
                                            <div class="form-group col-md-12">
                                                <button type="submit" class="btn btn-success btn-anim"><i
                                                        class="icon-rocket"></i><span class="btn-text">Tạo
                                                        Danh Mục</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>

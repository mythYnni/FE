    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Danh Sách Danh Mục Thủ Tục Hành Chính</h5>
            </div>
            ...
            <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><span>Danh Sách Danh Mục Thủ Tục Hành Chính</span></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
                                                            ...
                                                            <tbody>
                                                                @foreach ($list as $value)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ route('view_update_Proce', $value->linkText) }}"
                                                                                class="text-inverse pr-10" title="Edit"
                                                                                data-toggle="tooltip"><i
                                                                                    class="zmdi zmdi-edit txt-warning"></i>
                                                                            </a>
                                                                            <a href="{{ route('delete_Proce', $value->linkText) }}"
...
@section('ToastrWellcom')
    <script>
        toastr.success('Trang Danh Sách Danh Mục Thủ Tục Hành Chính!');
    </script>
@stop

                                                            ...
                                                            <tbody>
                                                                @foreach ($list as $value)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a class="text-inverse pr-10 showpProce"
                                                                                title="Show" alt="default"
                                                                                data-toggle="tooltip"
                                                                                data-id="{{ $value->linkText }}">
                                                                                <i class="fa fa-eye txt-success"></i>
                                                                            </a>
                                                                            <a href="{{ route('view_update_pProce', $value->linkText) }}"
                                                                                class="text-inverse pr-10" title="Edit"
                                                                                data-toggle="tooltip"><i
                                                                                    class="zmdi zmdi-edit txt-warning"></i>
                                                                            </a>
                                                                            <a href="{{route('delete_pProce', $value->linkText) }}"
                                                                                class="text-inverse" title="Delete"
                                                                                data-toggle="tooltip" onclick="return confirm('Bạn Có Chắc Muốn Xóa Không?')"><i

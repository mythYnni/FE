    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Thêm Mới Danh Mục Tư Vấn Pháp Luật</h5>
            </div>
            ...
            <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('list_lAdvice')}}"><span>Quản Lý Danh Mục Tư Vấn Pháp Luật</span></a></li>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-wrap">
                                        <form action="{{ route('create_lAdvice') }}" data-toggle="validator"

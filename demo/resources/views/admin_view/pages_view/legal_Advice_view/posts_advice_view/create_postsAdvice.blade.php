    ...
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Tạo Bài Viết Tư Vấn Pháp Luật</h5>
            </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-wrap">
                                        <form action="{{ route('create_pAdvice') }}" data-toggle="validator"
                                            ...
                                            <div class="col-md-4" style="padding: 0px;">
                                                <div
                                                    ...
                                                    <textarea class="form-control" rows="5" id="slug" onkeyup="ChangeToSlug();"
                                                        placeholder="ví dụ: Bài Viết Liên Quan Đến Tư Vấn Pháp Luật...." name="title" value="{{ old('title') }}"></textarea>
                                                    @error('title')

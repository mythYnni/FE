...
<div class="container-fluid">
     ...
     <div class="row heading-bg">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
               <h5 class="txt-dark">Thêm Mới Gói Dịch Vụ</h5>
          </div>
                    ...
                    <div class="panel-wrapper collapse in">
                         <div class="panel-body">
                              <div class="row">
                                   <div class="col-md-12">
                                        <div class="form-wrap">
                                             <form action="{{ route('create_sPrice') }}" data-toggle="validator" class="row no-gutters" role="form" method="post">
                                                  @csrf
                                                  <div class="col-md-5" style="padding: 0px;">
                                                       <div class="form-group col-md-7 @error('nameService') has-error has-danger @enderror">
                                                            ...
                                                            <input type="text" class="form-control" id="slug" onkeyup="ChangeToSlug();" placeholder="ví dụ: Gói 1" name="nameService" value="{{ old('nameService') }}">
                                                            @error('nameService')
                                                       ...
                                                       <div class="form-group col-md-5">
                                                            ...
                                                            <input type="text" class="form-control" id="convert_slug" placeholder="ví dụ: goi-1" readonly name="linkText" value="{{ old('linkText') }}">
                                                       </div>
                                                       <div class="form-group col-md-12 @error('begin') has-error has-danger @enderror" style="margin-bottom: 0px">
                                                            ...
                                                            <div class="row">
                                                                 <div class="form-group col-sm-6">
                                                                      <input type="number" class="form-control" placeholder="Thời Gian 1" name="begin" step="1" min="1" value="{{ old('begin') }}">
                                                                      @error('begin')
                                                                      <div class="help-block with-errors" style="color: red;">
                                                                           <ul class="list-unstyled">
                                                                                <li>{{ $message }}</li>
                                                                 ...
                                                                 <div class="form-group col-sm-6 @error('end') has-error has-danger @enderror">
                                                                      <input type="number" class="form-control" placeholder="Thời Gian 2" name="end" step="1" min="1" value="{{ old('end') }}">
                                                                      @error('end')
                                                                      <div class="help-block with-errors" style="color: red;">
                                                                           <ul class="list-unstyled">
                                                                                <li>{{ $message }}</li>
                                                       ...
                                                       <div class="form-group col-md-12 @error('price') has-error has-danger @enderror">
                                                            ...
                                                            <input type="number" class="form-control" id="inputAccount" placeholder="ví dụ: 500000(vnđ)" name="price" min="50" value="{{ old('price') }}" max="100000000000">
                                                            @error('price')
                                                            <div class="help-block with-errors" style="color: red;">
                                                                 <ul class="list-unstyled">
                                                                      <li>{{ $message }}</li>
                                                            ...
                                                            @enderror
                                                            <div class="help-block">Viết Đúng và Đử Chữ Số Giá Tiền Bạn Mong Muốn! <br /> Ví Dụ: 500000 (Hiểu Là 5 Trăm Nghìn)</div>
                                                       </div>
                                                  </div>
                                                  <div class="col-md-7">
                                                       @error('content')
                                                  ...
                                                  <div class="form-group col-md-12" style="text-align: end;">
                                                       <button type="submit" class="btn btn-success btn-anim"><i class="icon-rocket"></i><span class="btn-text">Tạo
                                                                 Gói</span></button>
                                                  </div>
                                             </form>
                                        </div>
...
<script>
     toastr.success('Trang Thêm Mới Gói Dịch Vụ!');

                                    ...
                                    <div class="form-wrap">
                                        <form data-toggle="validator" class="row no-gutters" role="form" method="post">
                                            ...
                                            <div class="col-md-5" style="padding: 0px;">
                                                <div
                                                    class="form-group col-md-7 @error('nameService') has-error has-danger @enderror">
                                                    <label for="inputName" class="control-label mb-10">Tên Gói</label>
                                                    <input type="text" class="form-control" id="slug"
                                                        onkeyup="ChangeToSlug();" placeholder="ví dụ: Gói 1"
                                                        name="nameService" value="{{ $obj->nameService }}">
                                                    @error('nameService')
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input type="text" class="form-control" id="convert_slug"
                                                        placeholder="ví dụ: goi-1" readonly name="linkText"
                                                        value="{{ $obj->linkText }}">
                                                </div>
                                                <div class="form-group col-md-12 @error('begin') has-error has-danger @enderror"
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-sm-6">
                                                            <input type="number" class="form-control"
                                                                placeholder="Thời Gian 1" name="begin" step="1"
                                                                min="1" value="{{ $begin }}">
                                                            @error('begin')
                                                                <div class="help-block with-errors" style="color: red;">
                                                                    <ul class="list-unstyled">
                                                        ...
                                                        <div
                                                            class="form-group col-sm-6 @error('end') has-error has-danger @enderror">
                                                            <input type="number" class="form-control"
                                                                placeholder="Thời Gian 2" name="end" step="1"
                                                                min="1" value="{{ $end }}">
                                                            @error('end')
                                                                <div class="help-block with-errors" style="color: red;">
                                                                    <ul class="list-unstyled">
                                                ...
                                                <div
                                                    class="form-group col-md-12 @error('price') has-error has-danger @enderror">
                                                    <label for="inputAccount" class="control-label mb-10">Giá Gói</label>
                                                    <input type="number" class="form-control" id="inputAccount"
                                                        placeholder="ví dụ: 500000(vnđ)" name="price" min="50"
                                                        value="{{ $price }}" max="100000000000">
                                                    @error('price')
                                                        <div class="help-block with-errors" style="color: red;">
                                                            <ul class="list-unstyled">
                                                                <li>{{ $message }}</li>
                                            ...
                                            <div class="col-md-7">
                                                 ...
                                                 <div class="panel panel-default card-view">
                                                      ...
                                                      <div class="panel-wrapper collapse in">
                                                           <div class="panel-body">
                                                                <textarea name="content" rows="20" class="summernote">{{ $obj->content }}</textarea>
                                                           </div>
                                                      </div>
                                                 </div>
                                            </div>
                                             <div class="form-group col-md-12" style="text-align: end;">
                                                     <button type="submit" class="btn btn-success btn-anim"><i class="icon-rocket"></i><span class="btn-text">Chỉnh
                                                               Sửa</span></button>
                                                </div>
                                        </form>
                                    </div>
